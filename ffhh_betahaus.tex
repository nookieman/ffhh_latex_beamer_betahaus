...
\begin{frame}{Wer sind wir?}
	...
	\vskip 1em
%	\begin{center}
		Kommunikation: kontakt@hamburg.freifunk.net
%	\end{center}
\end{frame}
...
\begin{frame}{Knotengraph}
	\begin{center}
		\includegraphics[width=0.64\textwidth]{knotengraph}
	\end{center}
\end{frame}

\begin{frame}{Knotenkarte}
	\begin{center}
		\includegraphics[width=0.9\textwidth]{knotenkarte}
	\end{center}
\end{frame}
